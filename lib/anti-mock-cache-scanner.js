...
if (require.main !== module) {
    ...
    module.exports = {
        ...
        UniversalSecurityEngine: require('./universal-security-engine.js').UniversalSecurityEngine,
        SecurityPatterns: require('./security.patterns.js'),

        // Legacy patterns (deprecated)
        VIOLATION_PATTERNS: {
            MOCK_PATTERNS: require('./security.patterns.js').MOCK_PATTERNS,
            CACHE_PATTERNS: require('./security.patterns.js').CACHE_PATTERNS,
            PERFORMANCE_VIOLATIONS: require('./security.patterns.js').PERFORMANCE_VIOLATIONS
        }
    };
}