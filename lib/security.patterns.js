...
const CACHE_PATTERNS = [
    ...
    {
        pattern: /cache\.get\s*\(/gi,
        type: 'CACHE_GET_DIRECT',
        severity: 'HIGH',
        category: 'CACHE_OPERATION',
        description: 'Direct cache get operation detected - การดึงข้อมูลจาก cache โดยตรง',
        recommendation: 'ใช้การดึงข้อมูลจากแหล่งจริงแทน cache'
    },
    {
    ...
    {
        pattern: /cache\.set\s*\(/gi,
        type: 'CACHE_SET_DIRECT',
        severity: 'HIGH',
        category: 'CACHE_OPERATION',
        description: 'Direct cache set operation detected - การเก็บข้อมูลใน cache โดยตรง',
        recommendation: 'ใช้การเก็บข้อมูลในแหล่งจริงแทน cache'
    },
    {
