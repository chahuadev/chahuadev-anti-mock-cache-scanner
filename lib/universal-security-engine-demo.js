#!/usr/bin/env node
// ======================================================================
// CHAHUADEV UNIVERSAL SECURITY ENGINE DEMO v2.0
// ======================================================================
// @author บริษัท ชาหัว ดีเวลลอปเมนต์ จำกัด (Chahua Development Co., Ltd.)
// @purpose Demo การใช้งาน Universal Security Engine แบบ Advanced
// ======================================================================

const { UniversalSecurityEngine, SecurityPatterns } = require('../chahuadev-code-analyzer/lib/universal-security-engine.js');
...
async function demo1_BasicUsage() {
    ...
    console.log(' สแกนไฟล์: code-analyzer.js');
    await engine.scanFile('code-analyzer.js');
